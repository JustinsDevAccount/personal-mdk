...
$(document).ready(function(){
	...
	var bgURL= bgBaseUrl;
	var mainBgUrl = "https://cdn.wallpapersafari.com/28/53/bSNRdF.jpg";
    var noOfPicturesInBgFolder = 3;
    var bgURLocal;
	...
	if(settings.background.daily){
	    //bgURL= bgURL + '/daily';
        Math.floor(Math.random() * noOfPicturesInBgFolder) + 1;
        bgURLocal = "media/backgrounds/" + noOfPicturesInBgFolder +".jpg";
	}

	$('body').css({
		//'background-image':'url('+ bgURL +')',
		//'background-image':'url('+ mainBgUrl +')',
		'background-image': 'url(media/backgrounds/main.png)',
        //'background-image': 'url(media/backgrounds/'+ bgURLocal+ '.jpg)',
